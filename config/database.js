    ...
    if(err) {
        ...
        (err) => {
            if (err) {
                ...
                db.run(insert, ["Kinesthetic Training","Train taking place, and always enjoy it!","https://image.spreadshirtmedia.net/image-server/v1/mp/designs/145633943,width=178,height=178,version=1550179364/hombre-de-dibujos-animados-mancuerna-ejercicio-ganancia-regalo.png","#00416A","#FFE000"])
            }
        });
    }
})
